...
public class HomePage extends ScreenManager {
	...
	@AndroidFindBy(xpath="//android.widget.EditText[contains(@text,'Chassis')]")
	public MobileElement chassisNumber;

	@AndroidFindBy(xpath="//android.widget.EditText[contains(@text,'Engine')]")
	...
	@AndroidFindBy(xpath="//android.widget.EditText[contains(@text,'Policy Number')]")
	...
	@AndroidFindBy(xpath="//android.widget.Button[@text='Yes, Agree']")
	public MobileElement agree;

	@AndroidFindBy(xpath="//android.widget.Spinner[contains(@resource-id,'etFinancierType')]")
	public MobileElement financierType;

	@AndroidFindBy(xpath="//android.widget.Spinner[contains(@resource-id,'etFinancierName')]")
	public MobileElement financierName;

	@AndroidFindBy(xpath="//android.widget.EditText[contains(@resource-id,'etFinancierAddress')]")
	public MobileElement financierAddress;

	@AndroidFindBy(xpath="//android.widget.TextView[@text='Financier Name']")
	public MobileElement financierNameText;

	@AndroidFindBy(xpath="//android.widget.TextView[@text='Salutation']")
	public MobileElement salutation;

	@AndroidFindBy(xpath="//android.widget.ImageButton[contains(@resource-id,'text_input_end_icon')]")
	public MobileElement textInputIcon;
	...
	@AndroidFindBy(xpath="//android.widget.RadioButton[@text='Thirdparty']")
	public MobileElement thirdparty;

	@AndroidFindBy(xpath="//android.widget.RadioButton[@text='Comprehensive']")
	public MobileElement comprehensive;
}

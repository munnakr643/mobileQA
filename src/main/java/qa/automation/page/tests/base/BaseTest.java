...
public class BaseTest {
	...
	public void isLoginPageDisplayed() {
		waitElement(loginPage.clickProceedBtn, 6);
		assertThat(loginPage.clickProceedBtn.isDisplayed(), equalTo(true));
	...
	public void clickListingProduct() {
		waitElement(UserProfilepage.ProductName, 6);
		assertThat(UserProfilepage.ProductName.isDisplayed(), equalTo(true));
		assertThat(UserProfilepage.Price.isDisplayed(), equalTo(true));
		UserProfilepage.ProductName.click();
	}

	public String getProductNameOnLp() {
		waitElement(UserProfilepage.ProductName, 6);
		assertThat(UserProfilepage.ProductName.isDisplayed(), equalTo(true));
		String st = UserProfilepage.ProductName.getText();
		return st;
	}

	public String getPriceOnLp() {
		waitElement(UserProfilepage.Price, 6);
		assertThat(UserProfilepage.Price.isDisplayed(), equalTo(true));
		String st = UserProfilepage.Price.getText();
		return st;
	}

	public void clickCartOnProductPage() {
		waitElement(QuotePage.CartOnProdctpage, 6);
		assertThat(QuotePage.CartOnProdctpage.isDisplayed(), equalTo(true));
		QuotePage.CartOnProdctpage.click();
	}

	public String getProductNameOnPdp() {
		waitElement(QuotePage.CartOnProdctpage, 6);
		assertThat(QuotePage.CartOnProdctpage.isDisplayed(), equalTo(true));
		String st = QuotePage.CartOnProdctpage.getText();
		return st;
	}
	...
	public void enterLoginId(String userId) {
		...
		loginPage.clickProceedBtn.click();
...
//		homePage.enterDate.sendKeys("10/10/2018");
	...
	public void selectExpiry(){
		waitElement(homePage.selectExpiry, 3);
		assertThat(homePage.selectExpiry.isDisplayed(), equalTo(true));
		homePage.selectExpiry.click();
	...
	public void selectPrevInsurerName(){
		waitElement(homePage.policyExpiryDate,3);
		assertThat(homePage.policyExpiryDate.isDisplayed(),equalTo(true));
		homePage.actv_valueDropdown.click();
		homePage.policyExpiryDate.click();
